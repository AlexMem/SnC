...
import com.eltech.snc.utils.Utils;
        ...
        for (int linesRow = 0; linesRow < mazeView.verticalLines.length; linesRow++) {
            ...
            for (int linesColumn = 1; linesColumn < mazeView.verticalLines[0].length - 1; linesColumn++) {
                ...
                if (mazeView.verticalLines[linesRow][linesColumn] == false) {
                    ...
                    Integer[] newEdgesV = Utils.removeValueFromArray(currentEdges, neighborVertexKey);
                    Integer[] newEdgesNeighbor = Utils.removeValueFromArray(currentEdgesNextVertex, currentVertexKey);
